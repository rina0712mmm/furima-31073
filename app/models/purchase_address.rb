class PurchasseAddress
  include ActiveModel::Model
  attr_accessor :postal_code, :prefecturees_id, :city, :house_number, :apartment, :phone_number, :item_id, :token
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city,
                    house_number: house_number, apartment: apartment, phone_number: phone_number, order_id: order.id )
    end
  end
